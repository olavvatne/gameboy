...
const opcodes = {
  ...
  0x71: (cpu) => { Z80.load8.LDrr(cpu, RegMap.c); },
  0x72: (cpu) => { Z80.load8.LDrr(cpu, RegMap.d); },
  0x73: (cpu) => { Z80.load8.LDrr(cpu, RegMap.e); },
  0x74: (cpu) => { Z80.load8.LDrr(cpu, RegMap.h); },
  0x75: (cpu) => { Z80.load8.LDrr(cpu, RegMap.l); },
  ...
  0xFA: (cpu) => { throw new Error(); },
  0x3E: (cpu) => { throw new Error(); },
